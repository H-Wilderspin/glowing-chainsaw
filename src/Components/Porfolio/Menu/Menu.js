...
export default function Menu() {
  const { dataState, thisAppName, converter, setCurrency } = React.useContext(ContextWhole)
  ...
  return (
    <div className='Menu-hero'>
      ...
      <Link to="/portfolio/menu/place-order"><button className='Menu-reviewOrderBtn'>Review Order</button></Link>

      <Footer
        thisAppName={thisAppName}
        thisAppDesign="https://www.figma.com/file/wXp9o76uQ5XS5MmsLpmX2I/Menu"
        thisAppGitRepository="https://github.com/H-Wilderspin/Foodie"
      />
